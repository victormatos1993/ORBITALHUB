...
export function ActionsCell({ supplier }: ActionsCellProps) {
    ...
    const onEdit = () => {
        router.push(`/dashboard/cadastros/fornecedores/${supplier.id}`)
        setOpen(false)
    }
        ...
        <>
            ...
            <DropdownMenu open={open} onOpenChange={setOpen}>
                ...
                <DropdownMenuContent align="end">
                    ...
                    <DropdownMenuItem onClick={() => onCopy(supplier.id)}>
